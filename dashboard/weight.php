                ...
                <div class="card-body card-block">
                    <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="row form-group">
                            <div class="col col-md-3"><label class=" form-control-label">ID Bobot</label></div>
                            <div class="col-12 col-md-9">
                                <p class="form-control-static"><?php $nextVal = $nWeight + 1; echo''.$nextVal.'';?></p>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="select" class=" form-control-label">Kriteria</label>
                            </div>
                            <div class="col-12 col-md-9">
                                ...
                                <?php
                                    while($dataRes = mysqli_fetch_array($resCriteria)) {         
                                        echo '<option value="'.$dataRes['id_kriteria'].'">'.$dataRes['nm_kriteria'].'</option>';
                                    }
                                ?>
                        ...
                        <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Skala</label>
                            </div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="text-input"
                                    placeholder="Masukkan Skala" class="form-control">
                            </div>
                        </div>
                    ...
                    <table id="bootstrap-data-table" class="table">
                        ...
                        <?php  
                                        while($dataRes = mysqli_fetch_array($resWeight)) {         
                                            ...
                                            echo '<td><button class="btn btn-info">Edit</button><button class="btn btn-danger ml-2">Hapus</button></td>';
                                            echo "</tr>";
                                        }
                                        ?>
                        </tbody>
