                ...
                <div class="card-body card-block">
                    <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="row form-group">
                            <div class="col col-md-3"><label class=" form-control-label">ID Alternatif</label></div>
                            <div class="col-12 col-md-9">
                                <p class="form-control-static" name="idAlternatif"><?php $nextVal = $nAlternatif + 1; echo''.$nextVal.'';?></p>
                            </div>
                        </div>

                        <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Alternatif</label>
                            </div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="nmAlternatif"
                                    placeholder="Masukkan Nama Alternatif" class="form-control">
                            </div>
                        </div>
                    ...
                    if(isset($_POST['Submit'])) {
                        ...
                        $result = mysqli_query($mysqli, "INSERT INTO tabel_alternatif(id_alternatif,nm_alternatif) VALUES('$nextVal','$nama')");
                    }
                    ?>
                </div>
            </div>
                    ...
                    <table id="bootstrap-data-table" class="table">
                        ...
                        <?php  
                                        while($dataRes = mysqli_fetch_array($resAlternatif)) {         
                                            echo '<tr>
                                                  <th scope="row">'.$dataRes['id_alternatif'].'</th>
