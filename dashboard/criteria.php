                ...
                <div class="card-body card-block">
                    <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="row form-group">
                            <div class="col col-md-3"><label class=" form-control-label">ID Kriteria</label></div>
                            <div class="col-12 col-md-9">
                                <p class="form-control-static"><?php $nextVal = $nCriteria + 1; echo''.$nextVal.'';?></p>
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="text-input"
                                    placeholder="Masukkan Nama Kriteria" class="form-control">
                            </div>
                        </div>
