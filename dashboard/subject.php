<?php
    ...
    $resQuestion = mysqli_query($mysqli, "SELECT id_matkul, nama_matkul, nm_alternatif FROM `tabel_matkul`,`tabel_alternatif` WHERE tabel_matkul.id_alternatif = tabel_alternatif.id_alternatif");
        ...
        <div class="content">
            <div class="card">
                <div class="card-header">
                    <strong>Form Mata Kuliah</strong>
                </div>
                <div class="card-body card-block">
                    <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                        <div class="row form-group">
                            <div class="col col-md-3"><label class=" form-control-label">ID Subjects</label></div>
                            <div class="col-12 col-md-9">
                                <p class="form-control-static">ID Subjects</p>
                            </div>
                        </div>

                        <div class="row form-group">
                            <div class="col col-md-3"><label for="text-input" class=" form-control-label">Nama Mata Kuliah</label>
                            </div>
                            <div class="col-12 col-md-9"><input type="text" id="text-input" name="text-input"
                                    placeholder="Masukkan Nama Mata Kuliah" class="form-control">
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <strong class="card-title">Tabel Mata Kuliah</strong>
                </div>
                <div class="card-body">
                    <table id="bootstrap-data-table" class="table">
                        ...
                        <?php
                            ...
                            echo'<tr>
                            <td>'.$dataRes['id_matkul'].'</td>
                            <td>'.$dataRes['nama_matkul'].'</td>
